...
var cliente = {
    data:  String(readlineSync.question(
        "Informe a data desejada no formato (ANO/MES/DIA): ")),
    quantidadeP: parseInt(readlineSync.question(
        "Informe a quantidade de caes pequenos: ")),
    quantidadeG: parseInt(readlineSync.question(
        "Informe a quantidade de caes grandes: ")),    
  }
...
if(precoTotal_meuCaninoFeliz < precoTotal_vaiRex && precoTotal_meuCaninoFeliz < precoTotal_chowChawgas){
    console.log("O PetShop mais barato e: " + nome_meuCaninoFeliz + "\nE o total a ser pago e R$" + precoTotal_meuCaninoFeliz.toString())
} else if (precoTotal_vaiRex < precoTotal_meuCaninoFeliz && precoTotal_vaiRex < precoTotal_chowChawgas){
    console.log("O PetShop mais barato e: " + nome_vaiRex + "\nE o total a ser pago e R$" + precoTotal_vaiRex.toString())
} else {
    console.log("O PetShop mais barato e: " + nome_chowChawgas + "\nE o total a ser pago e R$" + precoTotal_chowChawgas.toString())
}
